...
async function runCycle() {
    try {
        ...
        // --- Verificação e ajuste de ordens ativas ---
        ...
        for (let key of ['buy', 'sell']) {
            ...
            // --- Cancelamento inteligente considerando liquidez ---
